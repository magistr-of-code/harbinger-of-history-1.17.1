...
public class ManRenderer extends GeoEntityRenderer<Player> {
    public ManRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new ManModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public Identifier getTextureLocation(Player instance) {
        return new Identifier(HarbingerOfHistory.MOD_ID, "textures/entity/man.png");
    }
