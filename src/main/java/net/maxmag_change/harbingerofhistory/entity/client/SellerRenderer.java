...
public class SellerRenderer extends GeoEntityRenderer<Player> {
    public SellerRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new SellerModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public Identifier getTextureLocation(Player instance) {
        return new Identifier(HarbingerOfHistory.MOD_ID, "textures/entity/seller.png");
    }
